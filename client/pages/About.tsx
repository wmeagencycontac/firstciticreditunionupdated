  ...
  return (
    <section className="container mx-auto px-4 py-20 bg-gradient-to-br from-emerald-50 via-teal-50/20 to-cyan-50/30">
      <div className="text-center mb-16">
        <h2 className="text-4xl lg:text-5xl font-bold mb-4 bg-gradient-to-r from-[#00754A] to-[#005A39] bg-clip-text text-transparent">About First City Credit Union</h2>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Your trusted financial partner, serving our community with integrity and innovation for over 70 years.
        </p>
      </div>
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        <Card className="group border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] bg-gradient-to-br from-white to-emerald-50/30 overflow-hidden relative">
          ...
          <CardHeader className="relative">
            ...
            <CardTitle className="text-xl font-bold group-hover:text-[#00754A] transition-colors duration-300">Our History</CardTitle>
            <CardDescription className="text-base leading-relaxed">Seven decades of innovation and service in banking.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="group border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] bg-gradient-to-br from-white to-teal-50/30 overflow-hidden relative">
          ...
          <CardHeader className="relative">
            ...
            <CardTitle className="text-xl font-bold group-hover:text-[#00754A] transition-colors duration-300">Leadership Team</CardTitle>
            <CardDescription className="text-base leading-relaxed">Experienced professionals guiding our vision.</CardDescription>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2 text-muted-foreground mb-6">
              <li className="flex items-center gap-2"><ArrowRight className="w-4 h-4 text-[#00754A]" />Sarah Johnson, CEO</li>
        ...
        <Card className="group border-0 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.02] bg-gradient-to-br from-white to-cyan-50/30 overflow-hidden relative">
          ...
          <CardHeader className="relative">
            ...
            <CardTitle className="text-xl font-bold group-hover:text-[#00754A] transition-colors duration-300">Our Values</CardTitle>
            <CardDescription className="text-base leading-relaxed">Integrity, innovation, and community focus.</CardDescription>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2 text-muted-foreground mb-6">
              <li className="flex items-center gap-2"><ArrowRight className="w-4 h-4 text-[#00754A]" />Member-first service</li>
