...
class MonitoringService {
  ...
  public trackTransactionAttempt(
    type: string,
    amount: number,
    success: boolean,
  ) {
  ...
  public trackAuthenticationAttempt(
    method: string,
    success: boolean,
    reason?: string,
  ) {
  ...
  private setupPerformanceMonitoring() {
    if (typeof window !== "undefined" && "PerformanceObserver" in window) {
      ...
      try {
        ...
        this.debug("Performance observer not supported", {
          error: error.message,
        });
      }
    }
  ...
  public getSecurityEvents(
    ...
    if (severity) {
      filtered = this.securityEvents.filter(
...
export const useMonitoring = () => {
  ...
  return {
    ...
    trackTransactionAttempt:
      monitoring.trackTransactionAttempt.bind(monitoring),
    trackAuthenticationAttempt:
      monitoring.trackAuthenticationAttempt.bind(monitoring),
  };
};
