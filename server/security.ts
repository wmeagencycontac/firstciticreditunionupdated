...
export const validateDatabaseConnection = (req: Request, res: Response, next: NextFunction) => {
...
export const validateContentType = (req: Request, res: Response, next: NextFunction) => {
  if (req.method === 'POST' || req.method === 'PUT' || req.method === 'PATCH') {
    ...
    if (req.path.includes('/upload') || req.path.includes('/kyc') || req.path.includes('/mobile-deposit')) {
